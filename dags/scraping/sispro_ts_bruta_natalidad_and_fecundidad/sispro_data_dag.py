...
from dags.scraping.sispro_ts_bruta_natalidad_and_fecundidad.sispro_data_operator import (
    DataSispro4Operator, DataSispro5Operator, DataSispro7Operator
)

dag_id = "sispro_ts_bruta_natalidad_and_fecundidad_scraping"
